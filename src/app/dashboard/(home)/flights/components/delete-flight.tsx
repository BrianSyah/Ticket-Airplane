...
// Mendefinisikan tipe props untuk komponen DeleteFlight
...
const DeleteFlight: FC<DeleteFlightProps> = ({ id }) => {
  ...
  // Mengembalikan form yang memanggil deleteFlightWithId ketika disubmit
  return (
...
// Mengekspor komponen DeleteFlight sebagai default export
